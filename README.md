...
### .NET Standard 1.0 package (beta)

A Polly beta package supporting .NET Standard 1.0 is available via [Polly issues](https://github.com/App-vNext/Polly/issues) and intended shortly via [Nuget](https://www.nuget.org/packages/polly).
...
* [@reisenberger](https://github.com/reisenberger) - Add beta release supporting .NET Standard 1.0
